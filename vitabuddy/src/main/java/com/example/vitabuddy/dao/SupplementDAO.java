...
public class SupplementDAO {
    ...
    public List<UserSupplementDTO> findUserSupplementsByUserId(String userId) {
        return sqlSession.selectList("SupplementMapper.selectUserSupplements", userId);
    }
    ...
    public List<UserSupplementDTO> findSupplementsByKeywordAndBrand(String keyword, String brand) {
        ...
        List<UserSupplementDTO> results = sqlSession.selectList("SupplementMapper.findSupplementsByKeywordAndBrand", params);
    ...
    public int deleteSupplementBySupID(String userId, Integer supId) {
        ...
        return sqlSession.delete("SupplementMapper.deleteUserSupplement", params);
    }
